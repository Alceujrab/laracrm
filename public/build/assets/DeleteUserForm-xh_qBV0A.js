import { r as reactExports, R as React, d as requireReact, e as reactDomExports, j as jsxRuntimeExports, u as useForm } from "./app-BHvocwkH.js";
import { T as TextInput, I as InputError } from "./TextInput-CrxivzIC.js";
import { I as InputLabel } from "./InputLabel-DxHtwjV3.js";
import { s as s$3, Y, K, y as y$2, n as n$5, o as o$5, a as o$6, u as u$5, b as s$4, t as t$3, T as T$2, p as p$3, l as l$4, f as f$6, c as u$6, i as i$4, d as s$5, A as A$1, e as Ke$1, O as Oe } from "./transition-CaBnbbji.js";
function l$3(n2) {
  var u2;
...
function j({ children: l2, node: n2 }) {
  ...
  return React.createElement(d.Provider, { value: i2 }, l2, i2 === null && React.createElement(f$5, { features: s$2.Hidden, ref: (t2) => {
    var r2, u2;
    if (t2) {
...
function w$1(o3, t2) {
  ...
  return React.createElement(React.Fragment, null, v$12 && React.createElement(f$5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: A2, features: s$2.Focusable }), B({ ourProps: k2, theirProps: f2, defaultTag: $, name: "FocusTrap" }), v$12 && React.createElement(f$5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: A2, features: s$2.Focusable }));
}
...
let z = Y(function(t2, o3) {
  ...
  let ie = K();
  return React.createElement(s$5, null, React.createElement(l, { force: true }, React.createElement(te$1, null, React.createElement(w.Provider, { value: re2 }, React.createElement(X, { target: T3 }, React.createElement(l, { force: false }, React.createElement(ne2, { slot: N }, React.createElement(ee2, null, React.createElement(ge, { initialFocus: d2, initialFocusFallback: T3, containers: M2, features: E2 }, React.createElement(C$1, { value: m2 }, ie({ ourProps: le, theirProps: S$12, slot: N, defaultTag: Ne, features: We, visible: c2 === 0, name: "Dialog" })))))))))));
