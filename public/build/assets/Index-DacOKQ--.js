import { u as useForm, j as jsxRuntimeExports, a as axios, r as reactExports, c as usePage, H as Head_default } from "./app-CpdAeTN9.js";
import { A as AuthenticatedLayout, a as AtSign, C as Car, b as ChevronDown } from "./AuthenticatedLayout-CNDp9twW.js";
import { M as MessageSquare, C as CreateDealModal } from "./CreateDealModal-C9rZTEnl.js";
import { Z as Zap } from "./zap-CKkw8fsc.js";
import { X } from "./x-DLEb3HjG.js";
import { U as User } from "./user-DdbEj3EH.js";
import { F as FileText } from "./file-text-DwGGb-WK.js";
...
import { S as SquarePen } from "./square-pen-fUu4cDI_.js";
import { E as EllipsisVertical } from "./ellipsis-vertical-Cls8hBF5.js";
import { S as Search } from "./search-SYQrMeu3.js";
import { C as Check } from "./check-B9UUKDFs.js";
import { c as createLucideIcon } from "./createLucideIcon-UsPif6H6.js";
import { L as List } from "./list-CVXIO6fY.js";
...
const CircleStop = createLucideIcon("circle-stop", __iconNode$3);
/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const CreateProposalModal = ({ isOpen, onClose, conversation, onSuccess }) => {
  ...
  const [vehicleId, setVehicleId] = reactExports.useState("");
  const [notes, setNotes] = reactExports.useState("");
  const [validUntil, setValidUntil] = reactExports.useState("");
  const [items, setItems] = reactExports.useState([{ description: "Entrada", value: 0 }]);
  const [vehicles, setVehicles] = reactExports.useState([]);
  reactExports.useEffect(() => {
    var _a, _b;
    if (isOpen && conversation) {
      setTitle(`Proposta para ${((_a = conversation.contact) == null ? void 0 : _a.name) || "Cliente"}`);
      setVehicleId(((_b = conversation.deal) == null ? void 0 : _b.vehicle_id) || "");
    }
  }, [isOpen, conversation]);
  const addItem = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("/api/proposals", {
        ...
        deal_id: ((_a = conversation.deal) == null ? void 0 : _a.id) || null,
        title,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 transition-opacity", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gray-500 opacity-75" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg font-medium text-gray-900 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-5 h-5 text-indigo-600" }),
            "Gerar Nova Proposta"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: onClose, className: "text-gray-400 hover:text-gray-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-6 h-6" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700", children: "Título da Proposta" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700", children: "Validade" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "date",
                  value: validUntil,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700", children: "Veículo (ID opcional)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700", children: "Itens da Proposta" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: items.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-32", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 sm:text-sm", children: "R$" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-50 p-3 rounded-lg flex justify-between items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-gray-700", children: "Valor Total" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-bold text-indigo-700", children: [
              "R$ ",
              totalValue.toLocaleString("pt-BR", { minimumFractionDigits: 2 })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700", children: "Observações Internas" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
                value: notes,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "submit",
            ...
            children: loading ? "Gerando..." : "Confirmar e Gerar PDF"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
...
function InboxIndex({ conversations: initialConversations = [], users = [], deals = [], contacts = [], stages = [], vehicles = [], channels = [] }) {
  ...
  const [isProposalModalOpen, setIsProposalModalOpen] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        activeConv && /* @__PURE__ */ jsxRuntimeExports.jsx(
          CreateProposalModal,
          {
