import { u as useForm, j as jsxRuntimeExports, a as axios, r as reactExports, c as usePage, H as Head_default } from "./app-D5XQWmF0.js";
import { A as AuthenticatedLayout, a as AtSign, C as Car, b as ChevronDown } from "./AuthenticatedLayout-BE4-ngH3.js";
import { M as MessageSquare, C as CreateDealModal } from "./CreateDealModal-BJvFR3sW.js";
...
import { E as EllipsisVertical } from "./ellipsis-vertical-DFWN6xJr.js";
...
import { L as List } from "./list-BgioGnYg.js";
...
const CreateProposalModal = ({ isOpen, onClose, conversation, onSuccess }) => {
  ...
  const [title, setTitle] = reactExports.useState(`Proposta para ${conversation.contact.name}`);
  const [vehicleId, setVehicleId] = reactExports.useState(((_a = conversation.deal) == null ? void 0 : _a.vehicle_id) || "");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("/api/proposals", {
        ...
        deal_id: ((_a2 = conversation.deal) == null ? void 0 : _a2.id) || null,
        title,
